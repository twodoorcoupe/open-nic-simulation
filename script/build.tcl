...
# Add Vivado simulation resources
create_fileset -simset nic_test
current_fileset -simset nic_test
read_verilog -quiet -sv [glob -nocomplain -directory $sim_dir/file_tools "*.sv"]
read_verilog -quiet -sv [glob -nocomplain -directory $sim_dir/interfaces "*.sv"]
read_verilog -quiet -sv [glob -nocomplain -directory $sim_dir "*.sv"]
read_mem -quiet [glob -nocomplain -directory $src_dir/mem "*.mem"]
set_property verilog_define __250mhz__ [current_fileset -simset]
set_property top tb_open_nic_shell [current_fileset -simset]
